...
<body>
         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/download.png" alt=""> </a>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>What is Oitijjo Customer Care Number?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body">We value our customer’s time and hence moved away from a single customer care number to a comprehensive chat-based support system for quick and easy resolution. You no longer have to go through the maze of an IVRS call support. Just search for your issue in the help section on this page and initiate a chat with us. A customer care executive will be assigned to you shortly. You can also email us your issue on support@Oitijjo.in</div>
                           </div>
                        </div>
                        <!-- end:panel -->
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            <div class="col-xs-12 col-sm-5 right-image text-center">
                                <figure> <img src="images/app1.png" alt="Right Image" class="img-fluid"> </figure>
                            </div>
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>Oitijjo - The Best Traditional Food Delivery App</h3>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/download.png" alt="Footer logo"> </a> <span>Choose it &amp; Enjoy your meals! </span> </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address:</h5>
                            <p>Sheikh Fajilatunnessa Mujib University, Jamalpur 2000.</p>
                            <h5>Call us at: <a href="tel:+16216">+1 6 216</a></h5></div>
    ...
    <script src="js/oitijjo.js"></script>
</body>
