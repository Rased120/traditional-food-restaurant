...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/food.png">
    <title>Oitijjo - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <!-- Logo icon -->
                        <b><img src="images/food.png" alt="homepage" class="dark-logo" width = "25px"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><b>Oitijjo</b></span>
                    </a>
                </div>
                <!-- End Logo -->
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2023 All rights reserved by <b>Sheikh Fajilatunnessa Mujib University, Jamalpur </a> </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
